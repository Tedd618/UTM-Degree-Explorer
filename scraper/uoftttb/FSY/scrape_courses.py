        ...
        while retries > 0:
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"Page {page} failed with status {response.status_code}. Retrying...")
            except Exception as e:
                print(f"Page {page} exception: {e}. Retrying...")
            retries -= 1
            time.sleep(2)
...
if __name__ == "__main__":
    # Fall / Winter
    fw_sessions = ["20259", "20261", "20259-20261"]
    fetch_pages(fw_sessions, 83, "fall_winter_courses.json")

    # Summer 
    # Usually summer is '20265', maybe '20265F', '20265S' etc.
    summer_sessions = ["20265"]
    fetch_pages(summer_sessions, 17, "summer_courses.json")
